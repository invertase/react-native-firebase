...
const config: PackageConfig = {
  ...
  extraInRN: [],
  differentShape: [
    { name: 'FindNearestStageOptions', reason: 'JSDoc-only difference; structural shape matches SDK (vectorValue: VectorValue | number[]).' },
    { name: 'SampleStageOptions', reason: 'JSDoc-only difference in OneOf; structural shape matches SDK.' },
