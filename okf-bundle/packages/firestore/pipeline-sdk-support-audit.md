...
3. Close gates via the [change authoring primary loop](../../testing/change-authoring-workflow.md#primary-loop) (`documentation?` before frozen `independent-review`). Phase J e2e/harness: [work queue Phase J](pipeline-coverage-work-queue.md#phase-j-iteration-protocol-strict).
4. Record outcome:
