...
| -------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--slot N`           | off (serial) | Parallel slotted e2e in this worktree. Each platform subprocess gets its own `eval "$(yarn tests:e2e:export-slot-env <platform> N)"` — **never** one android export for all three.                                                                                                                                  |
