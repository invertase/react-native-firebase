...
| Gate             | Closes when                                                                                                                                                                                                                                                                                                                        |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `implementation` | `implementation` work type complete — code plus **unit-focused**-tier checks green on **every required platform** when native bridge, **committed `**/generated/**`**, podspec/spec/codegen wiring, macOS TS/runtime path, **or** `packages/*/e2e/**` changed ([platform coverage gate](running-e2e.md#platform-coverage-gate-blocking); [running e2e § Rules #3](running-e2e.md#rules)); [static analysis](validation-checklist.md#lint-and-formatting) green on the diff |
