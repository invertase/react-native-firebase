...
- [Coverage design](/testing/coverage-design.md) — unit/e2e coverage policy, native gates, Codecov; [iOS Ruby SimpleCov](/testing/coverage-design.md#ios-ruby-simplecov); [§ two test native modules](/testing/coverage-design.md#test-native-modules)
