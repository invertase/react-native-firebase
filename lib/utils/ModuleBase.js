...
import { nativeWithApp, nativeWithAppAndURL } from '../utils';
...
export default class ModuleBase {
   ...
   */
  constructor(firebaseApp: FirebaseApp, options: Object, withEventEmitter: boolean = false, url?: string) {
    ...
    if (!MULTI_APP_MODULES.includes(this._module.toLowerCase())) {
      ...
      if (MULTI_INSTANCE_MODULES.includes(this._module.toLowerCase())) {
        this._native = nativeWithAppAndURL(this._appName, this._url, nativeModule);
      } else {
