...
/**
 * JVM coverage for {@link RNFBAuthListenerRegistry}. Does not instantiate {@code
 * NativeRNFBTurboAuth} (React Native / Firebase) — D12.
 */
public class RNFBAuthListenerRegistryTest {

  private static final class FakeHandle implements AuthListenerHandle {
    int removeCount;
  ...
  public void putGetTake_happyPath() throws Exception {
    RNFBAuthListenerRegistry registry = new RNFBAuthListenerRegistry();
