...
public class RNFBFirestoreTransactionRegistryTest {
  ...
  @Test
  public void putOrSkip_sameIdFromTwoThreads_oneStored() throws Exception {
    RNFBFirestoreTransactionRegistry registry = new RNFBFirestoreTransactionRegistry();
    ReactNativeFirebaseFirestoreTransactionHandler first =
        new ReactNativeFirebaseFirestoreTransactionHandler("app", 10);
    ...
    ReactNativeFirebaseFirestoreTransactionHandler stored = registry.get(10);
