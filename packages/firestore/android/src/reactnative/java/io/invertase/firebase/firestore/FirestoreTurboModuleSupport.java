...
/**
 * Shared executor helpers for Firestore TurboModule shells (replaces ReactNativeFirebaseModule
 * inheritance when extending generated *Spec classes).
 */
final class FirestoreTurboModuleSupport {
  private final TaskExecutorService executorService;

  FirestoreTurboModuleSupport(String moduleName) {
