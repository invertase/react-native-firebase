 ...
 * `take` or `removeAll` then `remove` outside the HandleMap lock. Skip-if-registered is `get !=
 * nil`. Stored values are expected to respond to `remove`.
 */
@interface RNFBFirestoreListenerRegistry : NSObject
