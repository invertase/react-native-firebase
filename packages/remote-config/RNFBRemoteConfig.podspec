...
Pod::Spec.new do |s|
  ...
  # paths like `ios/RNFBRemoteConfigUnitTests/HostStubs/**` (those would compile into the pod).
  ...
  # DEFINES_MODULE is required for the generated RNFBRemoteConfig-Swift.h interface.
