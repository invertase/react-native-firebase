...
/// Remote Config update-listener map storage. Composes `RNFBHandleMapStorage`.
...
@objc(RNFBRemoteConfigListenerRegistryStorage)
public final class RNFBRemoteConfigListenerRegistryStorage: NSObject {
