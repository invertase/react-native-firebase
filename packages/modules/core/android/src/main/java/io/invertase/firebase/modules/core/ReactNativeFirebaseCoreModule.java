...
public class ReactNativeFirebaseCoreModule extends ReactContextBaseJavaModule {
  private static final String TAG = "RNFirebase";

  public ReactNativeFirebaseCoreModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
