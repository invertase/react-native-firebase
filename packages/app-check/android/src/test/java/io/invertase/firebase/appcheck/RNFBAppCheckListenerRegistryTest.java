...
/**
 * JVM coverage for {@link RNFBAppCheckListenerRegistry}. Does not instantiate {@code
 * NativeRNFBTurboAppCheck} (React Native / Firebase) — D12.
 */
public class RNFBAppCheckListenerRegistryTest {

  private static final class FakeHandle implements AppCheckListenerHandle {
    int removeCount;
  ...
  public void putGetTake_happyPath() throws Exception {
    RNFBAppCheckListenerRegistry registry = new RNFBAppCheckListenerRegistry();
