...
/** Proves the Kotlin port preserves Java null calls and remove ownership. */
public class UniversalFirebasePreferencesJavaCompatibilityTest {
  private SharedPreferences preferences;
  private SharedPreferences.Editor editor;
  private UniversalFirebasePreferences subject;
  ...
  public void setUp() throws Exception {
    ...
    when(editor.remove(null)).thenReturn(editor);
    ...
    subject = new UniversalFirebasePreferences();
    Field field = UniversalFirebasePreferences.class.getDeclaredField("preferences");
  ...
  @Test
  public void stringAccessorsAcceptNullsAndCanReturnNullToJava() {
  ...
  @Test
  public void removeAcceptsNullAndLeavesEditorCompletionToJavaCaller() {
    assertSame(editor, subject.remove(null));

    verify(editor).remove(null);
