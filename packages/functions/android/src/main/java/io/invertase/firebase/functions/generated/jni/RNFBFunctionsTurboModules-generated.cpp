...
#include "RNFBFunctionsTurboModules.h"
...
std::shared_ptr<TurboModule> RNFBFunctionsTurboModules_ModuleProvider(const std::string &moduleName, const JavaTurboModule::InitParams &params) {
