...
This will create a new React Native project in a folder called `<myProjectName>` with the `@react-react-native/app` package pre installed. The generated java package name 'com.<myProjectName>', while the XCode iOS Bundle Identifier is 'org.reactjs.native.example.<myProjectName>'
