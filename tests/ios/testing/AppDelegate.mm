...
//  [FIRAppCheck setAppCheckProviderFactory:providerFactory];
  ...
  NSDictionary *appProperties = [RNFBMessagingModule addCustomPropsToUserProps:nil withLaunchOptions:initProps];
  UIView *rootView = RCTAppSetupDefaultRootView(bridge, @"testing", appProperties);  
