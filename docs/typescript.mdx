...
If you are looking to setup a new project or migrate an existing project to TypeScript please check out this official [TypeScript documentation](https://reactnative.dev/docs/typescript).
