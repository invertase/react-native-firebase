...
description: 'In-App Messaging: Analytics dependency, campaign setup in the Firebase console, setMessagesDisplaySuppressed() to control display, campaign rate limits, and firebase.json auto-collection settings.'
