...
description: 'Manual Android linking for @react-native-firebase/in-app-messaging: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseFiamPackage in MainApplication.java.'
---
