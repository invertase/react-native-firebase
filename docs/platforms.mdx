...
MFA and TOTP flows are supported on **Other** platforms via the firebase-js-sdk auth bridge where documented — see [Multi-factor authentication](/auth/multi-factor-auth).
