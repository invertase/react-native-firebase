...
description: 'App Distribution for beta testers: new-version alerts and tester sign-in status via the JS API, with the rest of the service handled by native build integrations.'
next: /auth/usage
