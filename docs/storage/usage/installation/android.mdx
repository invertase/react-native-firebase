...
description: 'Manual Android linking for @react-native-firebase/storage: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseStoragePackage in MainApplication.java.'
---
