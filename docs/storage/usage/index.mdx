---
title: Cloud Storage
description: 'Cloud Storage: ref() references, putFile() uploads with Task upload-progress/pause/resume, getDownloadURL(), list() pagination, and multi-bucket access via getStorage(app, gs://bucket).'
next: /app/usage
