...
The `putFile` method returns a [`Task`](https://reference.rnfirebase.io/_react-native-firebase/storage/types/storage/Task.html), which if required, allows you to hook into information
