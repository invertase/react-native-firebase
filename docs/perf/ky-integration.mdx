...
description: Wire the ky HTTP client's beforeRequest/afterResponse hooks to Firebase Performance Monitoring's httpMetric() for automatic request latency tracking.
