---
title: Android Setup
description: 'Manual Android linking for @react-native-firebase/perf: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebasePerfPackage in MainApplication.java.'
---
