...
description: "Wire Axios request/response interceptors to Firebase Performance Monitoring's httpMetric(): start the metric on request, then set the response code/content-type and stop it on success or error."
