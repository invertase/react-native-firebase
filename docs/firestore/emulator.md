...
There are more things that can be achieved with the emulator such as using local rules to test the integrity & security of your datatbase. For further information, please follow the Firebase Emulator documentation [here](https://firebase.google.com/docs/emulator-suite).
