...
description: "Compare React Native Firebase's Firestore pipelines API to firebase-js-sdk: supported features, current gaps, and platform-specific execution notes."
