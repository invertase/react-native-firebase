...
> SendMessage and it's associated listeners, only fire from a custom XMPP server. Read the documentation on how to [setup iOS with Firebase Cloud Messaging](/messaging/usage/messaging-with-xmpp).
