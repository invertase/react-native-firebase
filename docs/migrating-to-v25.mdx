...
description: 'Migrate to v25: package-scoped modular type and export renames across Cloud Storage, Realtime Database, Remote Config, Performance Monitoring, Installations, App Check and Auth (deprecated provider helpers, multi-factor and phone auth signature changes).'
