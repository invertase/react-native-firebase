---
title: ML
description: 'Legacy Firebase ML module, mostly discontinued: use Google MLKit or the Cloud Vision APIs directly for new language identification, text recognition, image labeling or landmark recognition work.'
