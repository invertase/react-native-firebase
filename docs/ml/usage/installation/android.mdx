...
description: 'Manual Android linking for @react-native-firebase/ml: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseMLPackage in MainApplication.java.'
---
