---
title: AI Logic
description: 'Firebase AI Logic client SDK: getGenerativeModel() text and multi-modal generation, structured output, multi-turn chat, function calling, token counting, image generation, Google Maps grounding, Live API sessions, and App Check integration.'
