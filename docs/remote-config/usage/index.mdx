---
title: Remote Config
description: 'Remote Config: setDefaults(), fetchAndActivate()/fetch()/activate(), getValue()/getAll() and getSource(), minimumFetchIntervalMillis caching, and onConfigUpdate() real-time listeners.'
next: /perf/usage
previous: /ml/usage
---
