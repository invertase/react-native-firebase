...
description: 'Manual Android linking for @react-native-firebase/remote-config: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseConfigPackage in MainApplication.java.'
---
