---
title: Crashlytics
description: 'Crashlytics: logging events, setUserId()/setAttribute(s)(), recordError() for JS exceptions, crash(), setCrashlyticsCollectionEnabled(), and firebase.json flags for auto-collection, debug mode, NDK reporting and JS exception handling.'
