...
description: 'Manual Android linking for @react-native-firebase/crashlytics: settings.gradle module include, build.gradle dependency, registering ReactNativeFirebaseCrashlyticsPackage in MainApplication.java, and a link to the required Android Setup steps.'
---
