...
description: 'Migrate to v26: namespaced API removal from App, ML, In-App Messaging, Installations, Cloud Messaging, App Distribution and Cloud Functions, plus the New Architecture requirement and iOS APNs ARM64 Simulator Promise-rejection changes.'
previous: /migrating-to-v25
next: /migrating-to-v27
---
