---
title: App Check
description: App Check installation, attestation providers (DeviceCheck, App Attest, Play Integrity), custom providers via ReactNativeFirebaseAppCheckProvider, getToken(), and debug token setup for testing.
