...
description: 'Migrate to v22: switch from the namespaced API to modular functions, silence deprecation warnings with RNFB_SILENCE_MODULAR_DEPRECATION_WARNINGS, enforce the change with RNFB_MODULAR_DEPRECATION_STRICT_MODE, and a Firestore modular query rewrite example.'
previous: /
