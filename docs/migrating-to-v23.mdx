...
description: 'Migrate to v23: isCrashlyticsCollectionEnabled becomes a property, MultiFactorUser.enrolledFactors rename, an Analytics measurementId change, removal of Firebase Dynamic Links, and minSdk/iOS deployment target/Xcode version bumps.'
