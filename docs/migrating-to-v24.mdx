...
description: "Migrate to v24: Firestore TypeScript generic types for DocumentReference/Query/CollectionReference with separate type exports, and Cloud Functions becoming a TurboModule that requires React Native's New Architecture."
