...
description: 'Cloud Functions: calling deployed functions with httpsCallable(), connecting to the local emulator via connectFunctionsEmulator(), and targeting region-specific deployments.'
