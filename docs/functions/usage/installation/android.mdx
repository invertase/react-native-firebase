---
title: Android Setup
description: 'Manual Android linking for @react-native-firebase/functions: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseFunctionsPackage in MainApplication.java.'
---
