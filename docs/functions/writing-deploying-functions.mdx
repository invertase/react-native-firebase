...
description: 'Write and deploy Cloud Functions: firebase-tools setup, scaffolding, writing onCall() functions, local testing, security considerations, and deployment.'
