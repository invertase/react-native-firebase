...
description: "v6.2.0: Sign in with Apple support for Firebase Authentication on iOS via the new react-native-apple-authentication library, ahead of Apple's App Store Sign-In-with-Apple requirement."
---
