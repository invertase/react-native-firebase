...
description: 'v6.1.0: Firestore array-contains/array-contains-any/in queries, a Remote Config minimumFetchInterval setting, Firebase Android BOM v28.0.3 and iOS SDK v6.13.0, plus AdMob, Auth, Crashlytics, Database, Firestore, Messaging and Storage bug fixes.'
---
