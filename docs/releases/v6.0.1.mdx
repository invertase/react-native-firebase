...
description: 'v6.0.1 bug fixes: Auth verifyPhoneNumber casting/iOS crash, a Crashlytics setUserId crash with auto_collection disabled, Firestore settings/FieldPath/query-chaining fixes, and a Vision file:// path fix.'
---
