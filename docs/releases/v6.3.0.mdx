...
description: 'v6.3.0: adds iOS userAccessGroup support to the auth module and a Firestore QueryDocumentSnapshot interface, plus AdMob, Analytics, Auth, Crashlytics, Database and Firestore bug fixes.'
---
