...
description: 'v6.0.3 bug fixes: an iOS Realtime Database reload crash, Firestore QuerySnapshot.forEach TypeScript types, and an iOS Storage ph:// Photos asset upload fix.'
---
