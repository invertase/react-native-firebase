---
title: v6.4.0
description: 'v6.4.0: Messaging-focused release adding onNotificationOpenedApp()/getInitialNotification(), iOS setBackgroundMessageHandler() support, an upgraded iOS permissions API, and an iOS static-frameworks Podfile option, plus Analytics, Auth, Dynamic Links, Firestore, Functions and Storage fixes.'
---
