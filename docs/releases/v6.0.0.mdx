...
description: 'v6.0.0: split react-native-firebase into per-service @react-native-firebase/* packages, added firebase.json configuration, and rewrote App, AdMob, Analytics, Crashlytics, Firestore, Dynamic Links, Messaging, Remote Config and Storage, plus the new ML and In-App Messaging modules.'
---
