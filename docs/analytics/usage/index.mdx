---
title: Analytics
description: 'Analytics module: logEvent() for custom/predefined events, app instance IDs, disabling auto-init and screen tracking, IDFA/ATT opt-out, on-device conversion measurement, and DebugView setup.'
