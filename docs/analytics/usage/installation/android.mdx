...
description: 'Manual Android linking for @react-native-firebase/analytics: settings.gradle module include, build.gradle dependency, and registering ReactNativeFirebaseAnalyticsPackage in MainApplication.java.'
---
