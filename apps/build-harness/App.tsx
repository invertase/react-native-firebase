      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={[styles.card, {backgroundColor: cardColor}]}>
          ...
          <Text style={[styles.title, {color: primaryText}]}>
            Manual build and Firebase sync app
          </Text>
          <Text style={[styles.body, {color: secondaryText}]}>
            Run `yarn app:sync` from the repo root after changing dependency
            overrides or local Google Services files.
          </Text>
        </View>
        ...
        <View style={[styles.card, {backgroundColor: cardColor}]}>
          ...
          <Text style={[styles.body, {color: secondaryText}]}>
            These checks confirm the JavaScript modules load. Use a native build
            to verify bridge wiring and runtime behavior.
          </Text>
