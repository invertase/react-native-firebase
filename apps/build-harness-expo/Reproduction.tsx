...
export const checkTransactionReferenceArg: Parameters<Transaction['update']>[0] =
  null as unknown as DocumentReference<DocumentData, DocumentData>;
...
// Keep this screen aligned with apps/build-harness/Reproduction.tsx.
